    ...
    <section className="bg-white px-8 py-20 ssm:py-28">
      <div className="container">
        <div className="flex justify-between items-center mb-6">
          ...
          <img
            className="w-20 ssm:w-28 lg:w-36 xl:w-40"
            src={question}
            alt="FAQ"
          />
        </div>
        <div className="lg:flex lg:justify-start gap-5 xl:gap-10">
            ...
            {dataAccordion.map((item, index) => {
              return (
                <AccordionItem
                  ...
                  data={item}
                  onClick={() =>
                    index === openId ? setOpenId(null) : setOpenId(index)
                  }
                  isOpen={index === openId}
                />
              );
          ...
          <div className="bg-regal-blue rounded-2xl p-4 lg:w-80 lg:flex-shrink-0 lg:h-min">
            <div className="font-semibold text-xl lg:text-3xl xl:text-2xl text-white mb-3">
              Get a free consultation
            </div>
            <div className="text-sm text-white mb-4 ssm:text-base">
            ...
            <form className="" action="">
              <Dropdown
                ...
                isOpen={isOpen}
                setIsOpen={setIsOpen}
                placeholder={itemsSelect[countItem]}
              >
              ...
              <input
                className="w-full mb-2 rounded-md py-3 px-4"
                type="text"
                placeholder="Your Email"
              />
              <input
                className="w-full mb-4 rounded-md py-3 px-4"
                type="text"
            ...
            <button
              className="group hover:opacity-95 transition-opacity bg-[#34AADF] rounded-full py-1 w-full flex items-center justify-center gap-2"
              type="button"
            >
              <img
                className="h-10 group-hover:translate-x-2 group-hover:rotate-[360deg] duration-500 transition-transform"
                src={telegram}
                alt="Telegram"
              />
